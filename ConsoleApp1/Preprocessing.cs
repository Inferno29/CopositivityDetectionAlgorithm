                    ...
                    if (checkForGegativeDiagonals != null)
                    {
                        ...
                        for (int i = 0; i < saveForValuesVector.Length; i++)
                        {
                            ...
                            if (i <= length)
                            {
                                ...
                                temp += -violatingVectorShorter[i] * checkForGegativeDiagonals[i];
                                violatingVector[length - i] = temp;
                            ...
                            {
                                violatingVector[i - length] = saveForInputMatrix[indexOfMax, indexOfMax] * checkForGegativeDiagonals[i - 1];
                            }
